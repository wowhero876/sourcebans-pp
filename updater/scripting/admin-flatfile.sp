...
{
	name = "Admin File Reader (SB FIX)",
	author = "AlliedModders LLC, friagram",
...
#include "admin-flatfile/admin-overrides_fix.sp"
#include "admin-flatfile/admin-groups_fix.sp"
#include "admin-flatfile/admin-users_fix.sp"
#include "admin-flatfile/admin-simple_fix.sp"
