...
{
	CreateConVar("sbr_version", SB_VERSION, "Advanced admin and ban management for the Source engine", FCVAR_NOTIFY|FCVAR_PLUGIN);
...
public Query_ExecuteCallback(Handle:owner, Handle:hndl, const String:error[], any:pack)
{
	...
	new SQLTCallback:callback = SQLTCallback:ReadPackFunction(pack);
...
public Native_Query(Handle:plugin, numParams)
{
	...
	WritePackFunction(hPack, GetNativeFunction(1));
